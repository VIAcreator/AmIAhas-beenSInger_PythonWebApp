...
https://deepwiki.com/afiuh/bilibili-api-collect
https://blog.csdn.net/kiwi8/article/details/154415732
https://libraries.io/pypi/bilibili-api-python
...
原仓库地址：https://github.com/MoyuScript/bilibili-api (*现已被删除)
Github 仓库：https://github.com/nemo2011/bilibili-api
模块最早由 @MoyuScript 于 2020 年创建，于 2022 年宣布停止维护。本仓库是原仓库 fork，遵循 GNU General Public License Version 3。在此感谢早期的众多模块贡献者与 @MoyuScript 对新仓库的支持。 见 MoyuScript/bilibili-api 的 第一条 commit (2020.01.27)与 最后一条 commit (2022.01.17)。
简介
...
然后需要自行安装一个支持异步的第三方请求库，如 aiohttp / httpx / curl_cffi。
# aiohttp
...
A: 可以，但是你可能要自己动手实现模块和具体请求库的适配。详见 自定义请求库
Q: 怎么没有我想要的功能？
